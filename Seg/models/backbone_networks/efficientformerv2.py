...
def _cfg(url='', input_size=224, **kwargs):
    return {
        'url': url,
...
def efficientformerv2_s0(input_size=224, **kwargs):
    model = EfficientFormerV2(
        ...
        distillation=False, resolution=input_size,
        **kwargs)
    model.default_cfg = _cfg(crop_pct=0.9, input_size=input_size)
    # print(model.default_cfg)
    return model


def efficientformerv2_s1(input_size=224, **kwargs):
    model = EfficientFormerV2(
...
def efficientformerv2_s2(input_size=224, **kwargs):
    model = EfficientFormerV2(
        ...
        vit_num=4,
        drop_path_rate=0.02,
        e_ratios=expansion_ratios_S2, resolution=input_size,
        **kwargs)
    model.default_cfg = _cfg(crop_pct=0.9, input_size=input_size)
    return model
