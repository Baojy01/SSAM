...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            c1 = ch[f]
            args = [*args[1:]]
        elif m in {mobilenet_v2_075, mobilenet_v2_10, mobilenet_v2_14, mobilenet_v2_20,
                   mobilevit_xxs, mobilevit_xs, mobilevit_s, edgevit_xxs,  edgevit_xs,  edgevit_s,
                   efficientformerv2_s0, efficientformerv2_s1, efficientformerv2_s2,
                   SSAMNet_Tiny, SSAMNet_Small, SSAMNet_Base, SSAMNet_Large}:
            m = m(*args)
            c2 = m.dim_list  # 返回通道列表
            backbone = True
        else:
            c2 = ch[f]
