...
def mobilenet_v2_075(num_classes=1000, width_mult=0.75):
    model = MobileNetV2(num_classes=num_classes, width_mult=width_mult)
    return model


def mobilenet_v2_10(num_classes=1000, width_mult=1.0):
    model = MobileNetV2(num_classes=num_classes, width_mult=width_mult)
    return model


def mobilenet_v2_14(num_classes=1000, width_mult=1.4):
    model = MobileNetV2(num_classes=num_classes, width_mult=width_mult)
    return model


def mobilenet_v2_20(num_classes=1000, width_mult=2.0):
    model = MobileNetV2(num_classes=num_classes, width_mult=width_mult)
    return model


def mobilenet_v2_25(num_classes=1000, width_mult=2.5):
    model = MobileNetV2(num_classes=num_classes, width_mult=width_mult)
    return model
