...
def EfficientViT_M0(num_classes=1000, distillation=False, fuse=False, model_cfg=EfficientViT_m0):
...
def EfficientViT_M1(num_classes=1000, distillation=False, fuse=False, model_cfg=EfficientViT_m1):
    model = EfficientViT(num_classes=num_classes, distillation=distillation, **model_cfg)
    if fuse:
        replace_batchnorm(model)
    return model
...
def EfficientViT_M2(num_classes=1000, distillation=False, fuse=False, model_cfg=EfficientViT_m2):
    model = EfficientViT(num_classes=num_classes, distillation=distillation, **model_cfg)
    if fuse:
        replace_batchnorm(model)
    return model
...
def EfficientViT_M3(num_classes=1000, distillation=False, fuse=False, model_cfg=EfficientViT_m3):
    model = EfficientViT(num_classes=num_classes, distillation=distillation, **model_cfg)
    if fuse:
        replace_batchnorm(model)
    return model
...
def EfficientViT_M4(num_classes=1000, distillation=False, fuse=False, model_cfg=EfficientViT_m4):
    model = EfficientViT(num_classes=num_classes, distillation=distillation, **model_cfg)
    if fuse:
        replace_batchnorm(model)
    return model
...
def EfficientViT_M5(num_classes=1000, distillation=False, fuse=False, model_cfg=EfficientViT_m5):
    model = EfficientViT(num_classes=num_classes, distillation=distillation, **model_cfg)
    if fuse:
        replace_batchnorm(model)
    return model
