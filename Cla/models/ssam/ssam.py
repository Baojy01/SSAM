...
class SSAMNet(nn.Module):
    ...
    def __init__(self, arch='tiny', num_classes=1000):
        super().__init__()
...
def SSAMNet_Tiny(num_classes):
    model = SSAMNet(arch='t', num_classes=num_classes)
    return model


def SSAMNet_Small(num_classes):
    model = SSAMNet(arch='s', num_classes=num_classes)
    return model


def SSAMNet_Base(num_classes):
    model = SSAMNet(arch='b', num_classes=num_classes)
    return model

def SSAMNet_Large(num_classes):
    model = SSAMNet(arch='l', num_classes=num_classes)
    return model
